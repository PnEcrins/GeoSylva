...
mviewer.customLayers.secteurs_pne.layer = new ol.layer.Vector({
        source: new ol.source.Vector({
            url: "hhttps://geoserver.ecrins.net/geoserver/cite/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=GeoSylva%3Asecteurs_pne&maxFeatures=50&outputFormat=application/json&srsName=EPSG:3857",
